...
const fullText1 = ["hello, chào bạn. Bạn đang hong được vui hả?"];
const fullText2 = ["có chuyện gì hong nè, nói cho mình nghe với!"];
const fullText3 = ["mình sẻ ở đây lắng nghe bạn^^ "];
